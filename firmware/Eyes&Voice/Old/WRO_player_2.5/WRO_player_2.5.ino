...
void eyefLeft(int desiredPosition)
{
...
void eyefRight(int desiredPosition)
{
  static int currentPosition = 0;
...
void eyeLeft(int desiredPosition)
{
  ...
  eyepupilLeft.write(CLOSE_LEFT_EYE + currentPosition);
}
...
void eyeRight(int desiredPosition)
{
  ...
  eyepupilRight.write(CLOSE_RIGHT_EYE + currentPosition);
}
///////////////////////////////////////////
void loop()
{
...
//  pupilLeft(0);
  ...
  switch (condition)
  {
    ...
    case 25:
      exercise = 1;
      greetings = 0;
      myDFPlayer.play(18);    //давай поиграем
      condition++;
      break;
    case 26:
    ...
    case 31:
      ...
      break;
    case 32:
      myDFPlayer.play(16);    //Молодец, ты прошел игру
      timerCond = millis();
      condition++;
      break;
    case 33:
