...
void setup() {
  ...
  FastLED.addLeds<NEOPIXEL, 10>(pins, 64).setCorrection(TypicalLEDStrip);
  ...
  int i;
    switch (condition)
    {
      ...
      case 4:
        ...
        break;
      case 5: matrix->drawRGBBitmap(0, 0, (const uint16_t *) smile, 16, 8); matrix->show(); break;// эмоция - радость
      case 7: matrix->drawRGBBitmap(0, 0, (const uint16_t *) sad, 16, 8); matrix->show(); break;// эмоция - грусть
      case 9: matrix->drawRGBBitmap(0, 0, (const uint16_t *) surprised, 16, 8); matrix->show(); break;// эмоция - удивление
      case 11: matrix->drawRGBBitmap(0, 0, (const uint16_t *) angry, 16, 8); matrix->show(); break;// эмоция - злость
      case 13:
        matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap, 16, 8);
        matrix->show();
        for ( int i = 0; i < 15; i++)
      ...
      case 26:
        ...
        break;
      case 27:
        matrix->drawRGBBitmap(0, 0, (const uint16_t *) VERNO, 16, 8); matrix->show();
        for ( int i = 0; i < 15; i++)
        {
          cheeks[i] = 0x000000;
          matrix->show();
        ...
        break;
      case 29:
        matrix->drawRGBBitmap(0, 0, (const uint16_t *) NEVERNO, 16, 8); matrix->show();
        for ( int i = 0; i < 15; i++)
        {
          cheeks[i] = 0x000000;
          matrix->show();
