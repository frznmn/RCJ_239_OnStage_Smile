...
#define DISABLE_WHITE //для заполнения белым при старте - закомментировать//дла выключения - закомментировать
CRGB leds[NUMMATRIX];
  ...
  */
  ...
  if (Serial1.available() > 0)
  {
      ...
      switch (condition)
      {
        ...
        case 3: matrix->drawRGBBitmap(0, 0, (const uint16_t *) sad, 16, 8); matrix->show(); break;
        case 5: matrix->drawRGBBitmap(0, 0, (const uint16_t *) angry, 16, 8); matrix->show(); break;
        case 7: matrix->clear();  matrix->show(); break;
        default: break;
      }
