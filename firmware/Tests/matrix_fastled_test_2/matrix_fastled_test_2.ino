...
void loop() {
  ...
  */
  ...
  switch (condition)
  {
    case 1: matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap , 16, 8); matrix->show(); break;// эмоция - удивление
    case 2:
      ...
      break;
    case 3: matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap , 16, 8); matrix->show(); break;// эмоция - удивление
    case 4:
      if (millis() % 1000 > 500)
      {
        matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap, 16, 8);
      ...
      break;
    case 5: matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap , 16, 8); matrix->show(); break;// эмоция - удивление
    case 6:
      if (millis() % 1000 > 500)
      {
        matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap, 16, 8);
      ...
      break;// эмоция - радость
    case 7: matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap , 16, 8); matrix->show(); break;// эмоция - удивление
    case 8:
      if (millis() % 1000 > 500)
      {
        matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap, 16, 8);
      ...
      break;// эмоция - радость
    case 9: matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap , 16, 8); matrix->show(); break;// эмоция - удивление
    case 10: matrix->drawRGBBitmap(0, 0, (const uint16_t *) default_bitmap , 16, 8); matrix->show(); break;// эмоция - удивление
