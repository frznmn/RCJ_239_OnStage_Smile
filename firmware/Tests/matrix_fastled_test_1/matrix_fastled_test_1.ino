  ...
  */
  ...
  switch (condition)
  {
    ...
    case 24:
      ...
      break;
    case 27: matrix->drawRGBBitmap(0, 0, (const uint16_t *) VERNO, 16, 8); matrix->show(); break;
    case 29: matrix->drawRGBBitmap(0, 0, (const uint16_t *) NEVERNO, 16, 8); matrix->show(); break;
    case 31:
      for ( int i = 0; i < 15; i++)
      {
        cheeks[i] = 0x000000;
